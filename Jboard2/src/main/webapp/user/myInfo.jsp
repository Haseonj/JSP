...
<main id="user">
    <section class="register">
        ...
        <input type="hidden" name="rdate" value="${sessUser.rdate}">
            <table border="1">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="email" value="${sessUser.email}"/>
                        <button type="button" id="btnCheckEmail"><img src="/Jboard2/img/chk_id.gif" alt="중복확인"></button>
                        <button type="button" id="btnEmail" style="display: none;"><img src="/Jboard2/img/chk_auth.gif" alt="인증번호 받기"/></button>
                ...
                <tr>
                	<td>회원탈퇴</td>
                	<td>
                		<button type="button" id="btnDelete" style="padding: 6px; background: #ed2f2f; color: #fff;">탈퇴하기</button>
                	</td>
                </tr>
            </table>
            <div>
