...
<script>
	$(function(){
		...
		$.get('/Farmstory2/tabs.do?cate=notice', function(data){
		...
		$.get('/Farmstory2/tabs.do?cate=qna', function(data){
			for(let latest of data){
		...
		$.get('/Farmstory2/tabs.do?cate=faq', function(data){
			for(let latest of data){
        ...
        <main>
            ...
            <div class="quick">
                <a href="/Farmstory2/board/list.do?group=community&cate=menu&pg=1&search="><img src="./img/main_banner_sub1_tit.png" alt="오늘의 식단"></a>
                <a href="/Farmstory2/board/list.do?group=community&cate=chef&pg=1&search="><img src="./img/main_banner_sub2_tit.png" alt="나도 요리사"></a>                
            </div>

            <div class="latest">
                <div>
                    <a href="/Farmstory2/board/list.do?group=croptalk&cate=grow&pg=1&search="><img src="./img/main_latest1_tit.png" alt="텃밭 가꾸기"/></a>
                    <img src="./img/main_latest1_img.jpg" alt="이미지"/>
                    <table border="0">
                    	<c:forEach var="latests" begin="0" end="4" items="${latests}">
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=grow&no=${latests.no}">${latests.title}</a></td>
                            <td>${latests.rdate}</td>
                        </tr>
                        </c:forEach>
                    </table>
                ...
                <div>
                    <a href="/Farmstory2/board/list.do?group=croptalk&cate=school&pg=1&search="><img src="./img/main_latest2_tit.png" alt="귀농학교"/></a>
                    <img src="./img/main_latest2_img.jpg" alt="이미지"/>
                    <table border="0">
                        <c:forEach var="latests" begin="5" end="9" items="${latests}">
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=school&no=${latests.no}">${latests.title}</a></td>
                            <td>${latests.rdate}</td>
                        </tr>
                        </c:forEach>
                    </table>
                ...
                <div>
                    <a href="/Farmstory2/board/list.do?group=croptalk&cate=story&pg=1&search="><img src="./img/main_latest3_tit.png" alt="농작물 이야기"/></a>
                    <img src="./img/main_latest3_img.jpg" alt="이미지"/>
                    <table border="0">
                        <c:forEach var="latests" begin="10" end="15" items="${latests}">
                        <tr>
                            <td>></td>
                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=story&no=${latests.no}">${latests.title}</a></td>
                            <td>${latests.rdate}</td>
                        </tr>
                        </c:forEach>
                    </table>
